...
class UploadHandler
{
    ...
    protected function get_file_objects($iteration_method = 'get_file_object') {
        ...
        foreach ($arquivos as $arquivo) {
            $this->db->where('arquivo',$arquivo->name);
            $this->db->where('tabela',$this->options['tabela']);
            $this->db->where('campo',$this->options['campo']);
            $this->db->where('registro',$this->options['registro']);
            $file = $this->db->get('codemin_uploads')->row();
            $arquivo->id = $file->id;
            $arquivo->legenda = $file->legenda;
        }
        return $arquivos;
