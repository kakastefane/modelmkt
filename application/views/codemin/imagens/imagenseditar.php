            ...
            <div class="form-wrapper">
                ...
                <div class="control-group">
                    ...
                    <div class="col-lg-9 controls">
                        <input type="text" required="required" class="" value="<?= $edicao->nome; ?>" id="name" name="name">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="col-lg-9 controls">
                        <div class="input-group">
                            <input type="text" required="required" maxlength="5" class="" value="<?= $edicao->largura; ?>" id="width" name="width">
                ...
                <div class="control-group">
                    ...
                    <div class="col-lg-9 controls">
                        <div class="input-group">
                            <input type="text" required="required" maxlength="5" class="" value="<?= $edicao->altura; ?>" id="height" name="height">
                            <span class="input-group-addon">pixels</span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="checkbox">
                                <input type="checkbox" value="<?= $key ?>" <?php if (in_array($key, json_decode($edicao->json_pages))) echo 'checked' ?> name="json_pages[]">
                                Sim
                            </label>
                        </div>
                    </div>
