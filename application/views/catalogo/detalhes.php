...
$query = $this->db->query("SELECT 
      gercont_catalogo_categorias.nome
    FROM 
      gercont_catalogo_categorias
    WHERE
      gercont_catalogo_categorias.url_nome = '".$this->uri->segment(2)."'        
    ...
    <div class="container">
            <div>
                    <ul class="bread">
                        ...
                        <li>/</li>
                        <li><a href="catalogo/<?= $this->uri->segment(2)?>"><?= $categoria ?></a></li>
                        <li>/</li>
                        <li><?= $detalhe->nome ?></li>
                    </ul>
            </div>        
...
<br>
        <div class="row">
            ...
            <div class="col-sm-12 col-md-5">
                ...
                <a href="./uploads/catalogo_produtos/<?= $detalhe->id ?>/<?= $detalhe->capa ?>" class="fancybox"><img src="./uploads/catalogo_produtos/<?= $detalhe->id ?>/<?= $detalhe->capa ?>" alt="<?= $detalhe->nome ?>" width="100%"></a>
            ...
            <div class="col-sm-12 col-md-8 col-md-offset-2">
                ...
                <form action="./<?= $this->lang->line('rota_contato') ?>/enviar" class="row" id="form_contato">
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        <label>Produto</label>
                        <input type="text" name="nomeProduto" class="form-control required" readonly="" value="<?= $detalhe->nome ?>">
                    </div>                
    ...
    <div class="container">
        ...
        <div class="listaProdutos">
            ...
            $produtos = array(
                ...
                'limit' => 4,
                'ordenar' => array('rand()'),
                'where' => "gercont_catalogo_produtos.id <> ".$detalhe->id." ",
                'agrupar' => array('id')
            );
