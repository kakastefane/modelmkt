    	...
    	<div class="row">
	        ...
	        <form action="./newsletter/enviar" class="form-horizontal" id="form_newsletter">
	            ...
	            <div class="control-group">
	                ...
	                <div class="controls">
	                    <input type="text" name="nome" required placeholder="<?= $this->lang->line('newsletter_nome') ?>">
	                </div>
	            </div>
	            ...
	            <div class="control-group">
	                ...
	                <div class="controls">
	                    <input type="text" name="email" required placeholder="<?= $this->lang->line('newsletter_email') ?>">
	                </div>
	            </div>
